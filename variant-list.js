let data = [
...

    {
        ...
        desciption: "A blackout version of the original longo generator. Standard lockout rules apply.",
        color:"Blue",
...

    {
        ...
        desciption: "Teams have to tick all objectives that aren't bombs, while avoiding completing bomb objectives, players are required to tick all completed objectives. Except if the objective is known to be a bomb and required to complete an objective that is known to not be a bomb. Suggested size is 7x7 with 13 mines for 2+ players.",
        color:"Green",
        external_links:[{
            name:"Bookmark",
